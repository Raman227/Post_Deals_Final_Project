...
namespace Post_Deals_Final_Project.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterCompanyModel : PageModel
    {
        ...
        private Post_Deals_Context dataContext;
        ...
        public RegisterCompanyModel(
            ...
            Post_Deals_IDContext _context,
            Post_Deals_Context _dataContext
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var roleExistsResult = await _roleManager.RoleExistsAsync("company");
                    if (!roleExistsResult)
                    {
                        var roleReuslt = await _roleManager.CreateAsync(new IdentityRole("company"));
